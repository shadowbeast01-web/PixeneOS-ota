...
KEYS[AVB_BASE64]="${KEYS[AVB_BASE64]:-${KEYS_AVB_BASE64:-''}}"
KEYS[CERT_OTA]="${KEYS[CERT_OTA]:-ota.crt}"
KEYS[CERT_OTA_BASE64]="${KEYS[CERT_OTA_BASE64]:-${KEYS_CERT_OTA_BASE64:-''}}"
KEYS[OTA]="${KEYS[OTA]:-ota.key}"
KEYS[OTA_BASE64]="${KEYS[OTA_BASE64]:-${KEYS_OTA_BASE64:-''}}"
